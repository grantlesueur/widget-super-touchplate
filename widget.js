...
cpdefine("inline:com-chilipeppr-widget-super-touchplate", ["chilipeppr_ready", 'Three'], function() {
  return {
    ...
    initUI: function()  {
      ...
      $('#com-chilipeppr-widget-super-touchplate .btn-Centerfinder').click(this.onRun.bind(this, "cf"));
      //Tabs
    ...
    run_Centerfinder: function() {
      ...
      if(this.coordOffsetNo == 0)  {
       ...
       chilipeppr.publish("/com-chilipeppr-widget-serialport/jsonSend", {
        ...
        gcode = "G10 L2 P" + this.coordOffsetNo + " Y0 X0"
        chilipeppr.publish("/com-chilipeppr-widget-serialport/jsonSend", {
         Id: id,
         D: gcode
        });
    ...
    onRun: function(axis) {
      if (this.isRunning) {
        ...
        if (axis == "cf") this.run_Centerfinder();
    ...
    onRecvLineForProbe: function(data) {
      ...
      //console.log("grant look at this:", json);
      //console.log("grant look at this Running Axis =:", this.runningAxis);
      ...
      if ('prb' in json && 'e' in json.prb && this.runningAxis == "cf") {
        this.yOffset = json.prb.y;
        console.log("CF Offset from JSON: " + this.yOffset);
    ...
    onAfterProbeDone: function(probeData) {
      ...
      if (this.runningAxis == "z") {
        ...
        console.log("gls plateHeight:", plateHeight);
        ...
        var gcode = "";
          ...
          wcs_zoffset = Double.parseDouble(plateHeight) + Double.parseDouble(this.zOffset);
          console.log("gls ...wcs_offset: I made to Wcsoffset");
      ...
      if (this.runningAxis == "-x") {
        ...
        //Reverse the offset ie make it a negative seeing we are probing in the opposite direction
        var xoffset = -(br + plateWidth);
        if (isNaN(plateWidth)) plateWidth = 0;
        if (isNaN(br)) br = 0;
